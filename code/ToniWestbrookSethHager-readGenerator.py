#!/usr/bin/python3
#
# Read Generator via ART - readGenerator.py
#
# Anthony Westbrook             
# Seth Hager  
#
# usage: readGenerator.py [-h] [--art ART] [--samtools SAMTOOLS] [--gzip GZIP]
...
# 
# Read Generator Automation Wrapper for ART
# 
# optional arguments:
...
#
# Example: readGenerator.py --art C:\art\art_illumina.exe --fastadir C:\fastas --output C:\output --gzip C:\gzip\gzip.exe
